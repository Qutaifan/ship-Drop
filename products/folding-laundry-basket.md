...
### Competitor gate
**FAIL.** 11 competitor ads found in the DE Ad Library across 3 pages, but **0 are
true folding laundry basket product ads** and **0 have run 30+ days**. PROTOCOL-01
needs 5-10 genuine advertisers with at least 3 aged ads; neither condition is met.

Freight evidence: `reports/2026-08-30-cj-mcp-cost-check.md`.
